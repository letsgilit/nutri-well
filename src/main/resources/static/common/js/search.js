            ...
            success: function(result) {
               ...
               for (let i = 0; i < result.length; i++) {
                   ...
                   if (food.name === food.categoryName) {
                       const $img = $('<img class="img-fluid rounded" style="width: 100px; height: 100px;" alt="Image">').attr('src', `https://test-nutribucket.s3.ap-northeast-2.amazonaws.com/category/${food.categoryName}.jpg`);
                       $imgDiv.append($img);
                   } else {
                       const $img = $('<img class="img-fluid rounded" style="width: 100px; height: 100px;" alt="Image">').attr('src', `https://test-nutribucket.s3.ap-northeast-2.amazonaws.com/category/${food.categoryName}_${food.name}.jpg`);
                       $imgDiv.append($img);
                   }
